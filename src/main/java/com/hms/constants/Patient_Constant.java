...
public class Patient_Constant {
	...
	public static final String INSERT_SQL = "insert into Patient(address,contact_number,disease,email_id,gender,name)"
			+ " values(:address, :contact_number,:disease,:email_id, :gender, :name)";
	public static final String UPDATE_SQL = "update Patient set name=:name, address=:address,gender=:gender, "
			+ "disease=:disease, email_id=:email_id, contact_number=:contact_number where patient_id=:id";
